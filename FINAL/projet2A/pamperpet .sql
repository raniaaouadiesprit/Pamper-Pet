...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 21 mai 2021 à 12:47
...
INSERT INTO `client` (`NomClient`, `PrenomClient`, `IdClient`, `MdpClient`, `AdresseClient`, `EmailClient`, `TelClient`) VALUES
('ss', 'h', 44, 's', 's', 'sq', 44),
('ll', 'll', 45, 'gg', 'ss', 'ss', 12),
('yosri', 'yosri', 444, 'yosri', 'yosri', 'yosri', 255),
('kkkk', 'aaa', 554, '55', 'a', 'g', 666),
('hhh', 'hh', 44444, 'ggg', 'ggg', 'ggg', 454);
...
(1, 'ons', 'diwani', 'ons.diwani@gmail.com', '123456789', '24843222', 'tunis', 1),
