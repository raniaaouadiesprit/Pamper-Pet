...
function afficherevenment ($evenment){
	...
	function ajouterEvenment($evenment){
		$sql="insert into evenment (nbr_invt,nom_evn,date_evn,image,type_evn) values ( :nbr_invt,:nom_evn,:date_evn,:image,:type_evn)";
	...
	function modifierEvenment($evenment,$id){
		$sql="UPDATE evenment SET id=:idd,nbr_invt=:nbr_invt,nom_evn=:nom_evn,date_evn=:date_evn,image=:image,type_evn=:type_evn WHERE id=:id";
...
try{		
		...
		$datas = array(':idd'=>$id, ':id'=>$id, ':nbr_invt'=>$nbr_invt,':nom_evn'=>$nom_evn,':date_evn'=>$date_evn, ':image'=>$image, ':type_evn'=>$type_evn);
