...
try{		
        ...
        $id_commande=$livraison->getid_commande();
		$datas = array(':id_livraisonn'=>$id_livraison, ':id_livraison'=>$id_livraison,':id_livreur'=>$id_livreur, ':destination'=>$destination,':date'=>$date,':id_commande'=>$id_commande);
		$req->bindValue(':id_livraisonn',$id_livraison);
		$req->bindValue(':id_livraison',$id_livraison);
		$req->bindValue(':id_livreur',$id_livreur);
		$req->bindValue(':destination',$destination);
