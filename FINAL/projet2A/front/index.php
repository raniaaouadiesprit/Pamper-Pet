...
<html lang="en">
  <head>
    <title>PamperPet &mdash; Colorlib e-Commerce Template</title>
    <meta charset="utf-8">
...
<?php  
$bdd= new PDO('mysql:host=localhost; dbname=gestion-marketing','root','', array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8'));
