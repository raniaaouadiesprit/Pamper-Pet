...
include "../config.php";
    class ArticleC {
        ...
        $sql="insert into client (Nom_article,Quantite,Description_article,Nom_fabriquant,NomCategorie) values (:Nom_article, :Quantite,:Description_article,:Nom_fabriquant,:NomCategorie)";
        $db = config::getConnexion();
        try{
        $req=$db->prepare($sql);
