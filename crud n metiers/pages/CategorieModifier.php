...
if (isset($_GET['idCategorie'])){
    ...
    $result=$Categorie1C->recupererDataCategorie($_GET['idCategorie']);
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-7" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="AffichageCategorie.php">Categorie</a>
                                        </li>
            ...
            <div class="container-fluid dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                       ...
                       <form name="f" class="" method="Post" action="CategorieModifier2.php">

        <div class="position-relative form-group"><label for="exampleEmail" class="">idCategorie  : </label>
            <input name="idCategorie" id="lib" placeholder="idArticle..." type="text" class="form-control" 
            value="<?PHP echo $idCategorie ?>" disabled required></div>

      <div class="position-relative form-group"><label for="exampleEmail" class="">NomCategorie : </label>
        <input name="NomCategorie" id="lib" placeholder="Nom_article..." type="text" class="form-control"
        value="<?PHP echo $NomCategorie ?>"></div>
