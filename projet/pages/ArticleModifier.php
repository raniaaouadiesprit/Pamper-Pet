...
if (isset($_GET['idArticle'])){
    ...
    $result=$Article1C->recupererDataArticle($_GET['idArticle']);
    foreach($result as $row){
        $idArticle=$row['idArticle'];
        $Nom_article=$row['Nom_article'];
        $Quantite=$row['Quantite'];
        $Description_article=$row['Description_article'];
        $Nom_fabriquant=$row['Nom_fabriquant'];
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-7" aria-controls="submenu-7"><i class="fas fa-fw fa-file"></i> Stock </a>
                                <div id="submenu-7" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="AffichageArticle.php">Article</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/Categorie.html">Categorie</a>
                                        </li>
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid dashboard-content">
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">infoGeneral</a></li>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card ">
                            <h5 class="card-header">infoGeneral</h5>
                            <div class="card-body">
                         
                       <form name="f" class="" method="Post" action="ArticleModifier2.php">

        <div class="position-relative form-group"><label for="exampleEmail" class="">idArticle : </label><input name="Nom_article" id="lib" placeholder="idArticle..." type="text" class="form-control" value="<?PHP echo $idArticle ?>" disabled required></div>

        <div class="position-relative form-group"><label for="exampleEmail" class="">Nom_article : </label><input name="Nom_article" id="lib" placeholder="Nom_article..." type="text" class="form-control" value="<?PHP echo $Nom_article ?>"></div>

          <div class="position-relative form-group"><label for="exampleEmail" class="">Quantite : </label><input name="Quantite" id="des" placeholder="Quantite..." type="text" class="form-control" value="<?PHP echo $Quantite ?>"></div>

            <div class="position-relative form-group"><label for="exampleEmail" class="">Description_article : </label><input name="Description_article" id="lib" placeholder="Description_article..." type="text" class="form-control" value="<?PHP echo $Description_article ?>"></div>
       <div class="position-relative form-group"><label for="exampleEmail" class="">Nom_fabriquant : </label><input name="Nom_fabriquant" id="des" placeholder="Nom_fabriquant..." type="text" class="form-control" value="<?PHP echo $Nom_fabriquant ?>"></div>                                                    

                                                                                                                                    
                            <div class="card-body border-top">
                                <h5 class="card-title">Nom Catégorie</h5>
    <select name="NomCategorie" class="selectpicker" data-style="btn-secondary" value="<?PHP echo $NomCategorie ?>">
